...
public class DataDrivenExcel implements DataDrivenInput {
    ...
    public Map returnInputDataForDataId(int dataId) throws Exception {
        ...
        try {
            ...
            return (Map) inputParameters.get(String.valueOf(dataId));
    ...
    public String returnInputDataForDataIdAndColumnNumber(String dataId, int columnNumber) throws Exception {
        ...
        try {
            ...
            return (String)((Map)inputParameters.get(dataId)).get(columnNumber);
    ...
    public boolean hasDataId(int dataId) { 
    	...
    	return inputParameters.containsKey(String.valueOf(dataId));
    }
    ...
    public boolean hasDataId(String dataId) { 
    	...
    	return inputParameters.containsKey(dataId);
    }
